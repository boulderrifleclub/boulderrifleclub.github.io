...
2. General range rules
    ...
    3. Firearm and ammunition restrictions
...
3. Approved targets and target placement
...
4. Rules for specific ranges

    1. South range

        1. Rules governing use of full-auto (machine guns) at the South Range
    ...
    2. North range (all general rules apply)
